...
namespace SWRTS.Demo1
{
    ...
    public sealed class Demo1GameController : MonoBehaviour
    {
        ...
        private void CreateFallbackScenario()
        {
            ...
            witch.MaxHealth = 280f;
            witch.Attack = 56f;
            witch.Defense = 18f;
            witch.MaxMagic = 180f;
            witch.MaxShield = 110f;
            witch.MagicRecovery = 8f;
            ...
            support.MaxHealth = 270f;
            support.Attack = 40f;
            support.Defense = 16f;
            support.MaxMagic = 270f;
            support.MaxShield = 144f;
            support.GlobalShieldBonus = 0f;
            support.MagicRecovery = 14f;
            ...
            artillery.MaxHealth = 260f;
            artillery.Attack = 54f;
            artillery.Defense = 16f;
            artillery.MaxShield = 100f;
            ...
            nightWitch.MaxHealth = 270f;
            nightWitch.MaxMagic = 250f;
            nightWitch.MaxShield = 136f;
            nightWitch.Attack = 52f;
            nightWitch.Defense = 16f;
            nightWitch.MagicRecovery = 10f;
